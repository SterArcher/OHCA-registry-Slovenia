...
class CaseReport(models.Model):
    ...
    # interventionID = models.BigIntegerField(max_length=12) # TODO
    ...
    # estimatedCAtimestamp = models.BooleanField(null=True, blank=True)
    ...
    # diedOnField = models.SmallIntegerField(null = True, blank = True, validators=[MinValueValidator(-1), MaxValueValidator(1)])
    ...
    # firstDefibWho = models.SmallIntegerField(null = True, blank = True, validators=[MinValueValidator(-1), MaxValueValidator(2)]) # TODO which options? 
    ...
    drugTimings = models.TextField(null = True, blank = True)
    ...
    # hospitalName = models.CharField(null=True, blank=True, max_length=1000)
    ...
    # # TODO  loči možnosti za survival until discharge, survival 30days
