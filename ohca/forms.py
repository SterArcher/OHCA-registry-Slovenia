...
'Ženska')], 'helperCPR': [(-1, 'Neznano'), (0, 'Da'), (1, 'Ne')], 'helperWho': [(1, 'Oseba, ki jo je opozoril dispatch'), (2, 'Oseba z BLS, ki jo je opozoril dispatch'), (3, 
'Prvi posredovalec'), (4, 'Zdravstveno osebje izven časa službe, ki ga je poslal dispatch'), (5, 'Ostali, ki jih je poslal dispatch')], 'defiOrig': [(-1, 'Neznano'), (0, 'AED'), (1, 'EMS')], 'hospArri': [(-1, 'Neznano'), (0, 'Mrtev'), (1, 'Živ'), (2, 'Brez prevoza do bolnišnice'), (3, 'Prevoz z CPR'), (4, 'Prevoz z ROSC')]}

titles = {'caseID': 'UUID primera', 'systemID': 'UUID sistema', 'localID': 'UUID območja', 'dispIdentifiedCA': 'Dispečer je prepoznal prisotnost zastoja srca', 'dispProvidedCPRinst': 
'Dispečer je posredoval navodila za TPO', 'age': 'Starost', 'gender': 'Spol', 'witnesses': 'Priče zastoja', 'location': 'Lokacija zastoja', 'bystanderResponse': 'Odziv očividca', 'bystanderResponseTime': 'Začetek izvajanja TPO očividcev', 'bystanderAED': 'Uporaba AED', 'bystanderAEDTime': 'Čas prvega AED šoka očividcev', 'deadOnArrival': 'Mrtvogled', 'firstMonitoredRhy': 'Prvi zaznan ritem', 'pathogenesis': 'Patogeneza', 'independentLiving': 'Samostojno življenje', 'comorbidities': 'Pridružene bolezni', 'vad': 'VAD', 'cardioverterDefib': 'Kardioverter-defibrilator', 'stemiPresent': 'Prisoten STEMI', 'responseTime': 'Odzivni čas', 'defibTime': 'Čas do defibrilacije', 'ttm': 'Terapevtska hipotermija', 'ttmTemp': 'TTM Temperatura', 'drugs': 'Aplicirana zdravila', 'airwayControl': 'Tip nadzora dihalne poti', 'cprQuality': 'Kvaliteta TPO', 'shocks': 'Število elektrošokov', 'drugTimings': 'Čas do aplikacije zdravil', 'vascularAccess': 'Vaskularna pot', 'mechanicalCPR': 'Mehanski stiski prnega koša', 'targetVent': 'Ciljana okisgenacija/ventilacija', 'reperfusionAttempt': 'Poskus reperfuzije', 'reperfusionTime': 'Čas do poskusa reperfuzije', 'ecls': 'ECLS', 'iabp': 'IABP', 'ph': 'pH krvi', 'lactate': 'Laktate', 'glucose': 'Glukoza', 'neuroprognosticTests': 'Število in vrsta nevroprognostičnih testov', 'specialistHospital': 'Tip bolnišnice', 'hospitalVolume': 'Obremenitev bolnišnice', 'ecg': 'EKG z 12 odvodi', 'ecgBLOB': 'EKG datoteka', 'targetBP': 'Ciljano upravljanje krvnega pritiska', 'survived': 'Preživetje', 'rosc': 'ROSC', 'roscTime': 'Čas do ROSC', 'SurvivalDischarge30d': '30-dnevno preživetje ali preživetje do odpusta', 'cpcDischarge': 'Nevrološki izid ob odpustu (CPC)', 'mrsDischarge': 'Nevrološki izid ob odpustu (mRS)', 'survivalStatus': 'Status preživetja', 'transportToHospital': 'Transport v bolnišnico', 'treatmentWithdrawn': 'Zdravljenje prekinjeno (vključno s časom)', 'cod': 'Vzrok smrti', 'organDonation': 'Donacija organov', 'patientReportedOutcome': 'Pacientovo poročilo o izidu', 'qualityOfLife': 'Opredelitev kvalitete življenja (standardizirani vprašalniki, npr. EQ-5D, SF-12)', 'reaLand': 'Država srčnega zastoja', 'reaRegion': 'Regija srčnega zastoja', 'reaConf': 'Srčni zastoj potrjen', 'cprEms': 'Poskus oživljanja', 'cPREMS3Time': 'Kdaj so začeli oživljati NMP', 'noCPR': 'NMP ni oživljal', 'patID': 'treba še dodati', 'reaYr': 'Leto srčnega zastoja', 'reaMo': 'Mesec srčnega zastoja', 'reaDay': 'Dan srčnega zastoja', 'reaTime': 'Čas srčnega zastoja', 'reaCause': 'Vzrok srčnega zastoja', 'timeTCPR': 'Čas začetka CPR', 'gbystnader': 'Spol očividca', 'ageBystander': 'Starost očividca', 'cPRbystander3Time': 'Čas začetka CPR očividca', 'helperCPR': 'Oseba poslana, da pomaga s CPR', 'helperWho': 'Kdo je bil poslan, da pomaga?', 'cPRhelper3Time': 'Čas začetka PCR osebe, ki je poslana da pomaga', 'defiOrig': 'Prvi šok je dostavil AED ali NMP', 'timeROSC': 'Čas prvega ROSC', 'endCPR4Time': 'Čas konca CPR', 
'leftScene5Time': 'Čas zapusitve dogodka', 'hospitalArrival6Time': 'Čas prihoda v bolnišnico', 'hospArri': 'Status ob prihodu v bolnišnico', 'dischDay': 'Dan odpustitve iz bolnice'}

descriptions = {'caseID': 'Unikaten ID primera', 'systemID': 'Unikaten ID sistema, v katerem je bil primer oskrbovan', 'localID': 'Unikaten ID območja, kjer je bil primer oskrbovan', 'age': 'Starost pacienta ob dogodku - datum rojstva ali starost v letih', 'location': 'Lokacija pacienta ob incidentu', 'pathogenesis': 'Opomomba: neznani razlogi naj bodo opredeljeni kot zdravstvena težava.', 'independentLiving': 'Ali pacient živi sam', 'responseTime': 'Odzivni čas v sekundah - od časa sprejema klica do prihoda do pacienta', 'defibTime': 'Čas do defibrilacije v sekundah - čas od sprejema klica do prvega šoka', 'ttmTemp': 'Ciljna temperatura, če TTM izveden (v Kelvinih)', 'drugs': 'Set vseh uporabljenih zdravil, dovoljena izbira večih (kot vsota ID-jev vrednosti)', 'airwayControl': 'Set vseh uporabljenih tipov nadzora dihalne poti, dovoljena izbira večih (kot vsota ID-jev vrednosti)', 'drugTimings': 'JSON, kot opisan', 'targetVent': 'Če je ta spremenljivka uporabljena, vključi podrobnosti o specifičnih ciljih v opisu sistema', 'reperfusionAttempt': 'Set vseh poskusov reperfuzije, dovoljena izbira večih (kot vsota ID-jev vrednosti)', 'neuroprognosticTests': 'JSON, kot opisan', 'specialistHospital': 'Ali je bolnišnica specialistični center', 'hospitalVolume': 'Število letnih primerov', 'ecgBLOB': 'EKG datoteka kot base64 kodirani podatki', 'targetBP': 'Ciljni MAP v mmHg', 'roscTime': 'Čas do ROSC v sekundah', 'survivalStatus': 'Opisuje preživetje dogodka do sprejema v bolnišnico', 'treatmentWithdrawn': 'Ure do prekinitve zdravljenja, dnevi naj se pretvorijo v ure (zaokroženo navzgor)', 'cod': 'Vzrok smrti kot koda MKB-10-AM ver. 6', 'organDonation': 'Je pacient donor organov', 'patientReportedOutcome': 'Izidi, ki jih pacient opredeli kot pomembne', 'qualityOfLife': 'JSON, kot opisan', 'reaLand': 'Država srčnega zastoja v tekst formi', 'reaRegion': 'Regija srčnega zastoja v tekst formi', 'cPREMS3Time': 
