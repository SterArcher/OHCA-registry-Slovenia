...
'Gasilec (prvi posredovalec), ki ga je na kraj zastoja poslal dispečer'), (4, 'Zdravstveni delavec, ki trenutno ni v službi, in ga je na kraj zastoja poslal dispečer'), (5, 'Ostali, ki jih je na kraj zastoja poslal dispečer (ostale skupine, ki niso navedene zgoraj)')], 'defiOrig': [(-1, 'Neznano'), (0, 'AED'), (1, 'NMP (tudi, če je NMP uporabil AED - npr. MoENRV ali motorist - se označi odgovor')], 'hospArri': [(-1, 'Neznano'), (0, 'Mrtev'), (1, 'Živ'), (2, 'Brez prevoza do bolnišnice'), (3, 'Prevoz z CPR'), (4, 'Prevoz z ROSC')]}
