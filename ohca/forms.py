...
'Ženska')],'estimatedAgeBystander': [(-1, 'Neznano'), (0, 'Da'), (1, 'Ne')], 'helperCPR': [(-1, 'Neznano'), (0, 'Da'), (1, 'Ne')], 'helperWho': [(1, 'Oseba, ki jo je opozoril dispatch'), (2, 'Oseba z BLS, ki jo je opozoril dispatch'), (3, 
...
'reaLand', 'reaRegion', 'reaConf', 'cprEms', 'cPREMS3Time', 'noCPR', 'reaYr', 'reaMo', 'reaDay', 'reaTime', 'reaCause', 'timeTCPR', 'gbystnader', 'ageBystander', 'estimatedAgeBystander','cPRbystander3Time', 'helperCPR', 'helperWho', 'cPRhelper3Time', 'defiOrig', 'timeROSC', 'endCPR4Time', 'leftScene5Time', 'hospitalArrival6Time', 'hospArri', ]
