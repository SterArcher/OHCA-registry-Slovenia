...
class DSZ_1_DAN(forms.ModelForm):
	...
	adHospitalName = forms.IntegerField(widget=forms.RadioSelect(choices=((-1, "Neznano/ni podatka"), (-9999, "Ni zabeleženo/ni zavedeno"))), required=False)
	adBystAge = forms.IntegerField(widget=forms.RadioSelect(choices=((-1, "Neznano/ni podatka"), (-9999, "Ni zabeleženo/ni zavedeno"))), required=False)
