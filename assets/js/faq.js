...
for (let i=1;i<(questions.length+1);i++){
     ...
     var questionField = document.getElementById("q" + num);
     var questionCode = "<h6>" + question + "</h6><div class=\"faq-answer\"><h7 id=\"a" + num + "\"></h7></div>"
     console.log(questionCode);
     questionField.innerHTML = questionCode;

     var buttonField = document.getElementById("button" + num);
     ...
     buttonField.innerHTML = buttonCode;

     var copyField = document.getElementById("copy" + num);
     ...
     copyField.innerHTML = copyCode;
}

// OPEN QUESTION OD ID LINK
...
for (let i=1;i<(answers.length+1);i++){
     var num = i.toString();
     if (url == "https://siohca.um.si/faq/#q" + num){
